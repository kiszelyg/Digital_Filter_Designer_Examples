...
#include "MyFilter_firi64cpp11.hpp" // STEP 0: Include the generated header file of the filter implementation
...
int main()
{
	CMyFilterFirI64Cpp11 l_myFilter; // STEP 1: Make a filter instance
