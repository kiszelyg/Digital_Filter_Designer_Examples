...
// Code file of BSF C++11 IIR filter implementation with the datatype of long long
...
#include "BSF_iiri64cpp11.hpp"

void CBSFIirI64Cpp11::resetFilter()
{
    m_n = 0;
...
long long CBSFIirI64Cpp11::doFiltering(long long f_inputVal)
{
...
void CBSFIirI64Cpp11::doRwdFiltering()
{
    for (auto& l_iirSegment : m_iirSegments_vec)
    {
