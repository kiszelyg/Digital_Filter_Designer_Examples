...
// Code file of BSF2 C++11 IIR filter implementation with the datatype of long long
...
#include "BSF2_iiri64cpp11.hpp"

void CBSF2IirI64Cpp11::resetFilter()
{
    m_n = 0;
...
long long CBSF2IirI64Cpp11::doFiltering(long long f_inputVal)
{
...
void CBSF2IirI64Cpp11::doRwdFiltering()
{
    for (auto& l_iirSegment : m_iirSegments_vec)
    {
