...
#include "MyFilter_iiri64cpp11.hpp"  // STEP 0: Include the generated header file of the filter implementation
...
int main()
{
	CMyFilterIirI64Cpp11 l_myFilter; // STEP 1: Make a filter instance
